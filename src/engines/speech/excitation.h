...
// Glottal excitation (module_speech.md "Excitation"): a two-slope triangular
...
// Jitter (module_speech.md "Jitter and shimmer"): per-cycle randomisation of
...
// (the LFSR draw is skipped entirely, not just multiplied by zero) so
// jitter == 0 reproduces the plain, unperturbed pitch period bit-exactly.
