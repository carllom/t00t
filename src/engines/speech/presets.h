...
static constexpr SpeechPreset presets[SPEECH_PRESET_COUNT] = {
    ...
    { "LOOP CHANT",  PHRASE_HELLO_WORLD,  PH_SIL, SPEECH_MODE_LOOP,    20, speech_q8_8(1.0f), speech_q8_8(1.0f),           0,   0,  0.0f, 0.0f, false },
    { "ROBOTIC",     PHRASE_GOOD_MORNING, PH_SIL, SPEECH_MODE_GATED,   16, speech_q8_8(1.0f), speech_q8_8(0.5f),           0,   0,  0.0f, 0.0f, false },
    { "BREATHY",     PHRASE_TRACK_SAVED,  PH_SIL, SPEECH_MODE_GATED,   16, speech_q8_8(1.0f), speech_q8_8(2.4f),          40,  30,  5.0f, 0.15f, false },
    { "TRACT UP",    SPEECH_NO_UTTERANCE, PH_I,   SPEECH_MODE_GATED,   16, speech_q8_8(1.55f), speech_q8_8(1.0f),          0,   0,  0.0f, 0.0f, false },
    { "TRACT DOWN",  SPEECH_NO_UTTERANCE, PH_U,   SPEECH_MODE_GATED,   16, speech_q8_8(0.75f), speech_q8_8(1.0f),          0,   0,  0.0f, 0.0f, false },
    { "BOT CHORUS",  PHRASE_DRUM_MACHINE, PH_SIL, SPEECH_MODE_ONESHOT, 16, speech_q8_8(1.0f), speech_q8_8(0.5f),           0,   0,  0.0f, 0.0f, true  },
};
