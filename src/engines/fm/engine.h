...
// per #10. This is module_fm.md §3.4's working assumption for full 6-operator
...
// -- see module_fm.md §3.4. Only this engine -- the other four are untouched.
...
// FM engine (#44, module_fm.md P1): the first musically real slice -- a 6-operator
...
// delay/reverb stay linked (module_fm.md §2: "FM's whole working set is ~12 KB, so
...
struct VoiceParams {
    ...
    const FmPatch *patch;    // the whole timbre, one pointer (module_fm.md §6.3) -- always &FM_TEST_PATCH until P3's converter
