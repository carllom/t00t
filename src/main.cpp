...
int main() {
    ...
    // Core 1's thread exists, since Core 1 doesn't touch the ring until
    // the first DMA-triggered fill request anyway (that starts even later,
    // at i2s_output_init() below).
