...
// Full phase cycle length and mask (20 effective bits)
static constexpr uint32_t PHASE_CYCLE = WAVETABLE_SIZE << PHASE_FRAC_BITS;
static constexpr uint32_t PHASE_CYCLE_MASK = PHASE_CYCLE - 1;
