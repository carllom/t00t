// Host-buildable visual preview of subtractive's Performance/DIAG Page
// layout (src/engines/subtractive/display.cpp) against representative
// synthetic telemetry -- lets the layout be eyeballed as a PNG before
// flashing real hardware. Not a unit test: duplicates display.cpp's widget
// calls with fixed sample data, same reason preview_opl_display.cpp /
// preview_fm_display.cpp / preview_chip_display.cpp do.
...
static constexpr int CPU_Y = BODY_Y0, VOICES_Y = 60, VGRID_Y = 80, NOTE_Y = 104;
...
int main() {
    ...
    char text[24];
    snprintf(text, sizeof(text), "#%-3d %.10s", 2, "Saw-Flt");
    value_row_draw_value(preset_row, 2, text, 4, PRESET_Y, 28, 1, COL_VALUE, COL_BG);

    int fx_mix = 70, fx_p1 = 55, fx_p2 = 20, mod = 60;
    ...
    write_ppm("/tmp/claude-1000/-home-carl-t00t/9b60f263-674b-4d9d-aa37-7211fbf4344a/scratchpad/subtractive_performance.ppm");
    ...
    write_ppm("/tmp/claude-1000/-home-carl-t00t/9b60f263-674b-4d9d-aa37-7211fbf4344a/scratchpad/subtractive_diag.ppm");
