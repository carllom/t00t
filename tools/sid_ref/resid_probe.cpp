...
//
// sid.md §5.1: "The 6581 cutoff curve varied enormously between physical
...
int main(int argc, char **argv) {
    ...
    for (size_t r = 0; r < runs.size(); r++) {
        ...
        // (sid.md §10) and is fitted separately; leaving it in here would put
