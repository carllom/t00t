...
def generate_cpp_header() -> str:
    """Mirror of this file's struct/enum layout, for the device side once a
    later issue wires the tracker mixer up to consume these blobs. Not
    included by CMakeLists.txt yet (#14 is host-only) — regenerate via
    `xm2t00t.py gen-header` whenever a struct here changes."""
    ...
    lines = [
        ...
        "//   python3 tools/xm2t00t/xm2t00t.py gen-header src/tracker/blob_format.h",
        "#pragma once",
        "",
        "#include <cstdint>",
        "",
