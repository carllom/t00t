...
This is fm2.md §6, the recommendation the whole rewrite was organised around:
...
# purpose is to isolate one parameter (fm2.md §5.11, §5.19). The synthetic ones
...
# of them -- F5 (fm2.md §5.12) added multi-note coverage for exactly that
...
# meaningless on the inharmonic patches (fm2.md §5.9) and level gap is already
# implied by env.
...
def main(argv=None):
    ...
    if a.update:
        ...
        prev["_comment"] = (
            "Committed timbral regression baseline (fm2.md §6). Generated by "
